...
class EditView extends GetView<EditController> {
  ...
  Widget build(BuildContext context) {
    ...
    var userById = homeCont.findById(userId);
    controller.nameCont.text = userById.name.toString();
    controller.jobCont.text = userById.job.toString();
    controller.emailCont.text = userById.email.toString();
    return Scaffold(
      appBar: AppBar(
